...
import { isElementEqual, isAllX } from "../generatorUtils/generatorUtils.js";

export default class VerilogGenerator {
  ...
  stateRegister() {
    let content = `<span class="lineBlock">
                       ...
                       <span class="lineBlock">
                            ...
                            <span>(reset) pre <= ${
                              this.data.stateName[this.data.start - 1]
                            };</span>
                       </span>
                       <span class="lineBlock">
                            <span>&nbsp;&nbsp;</span>
    ...
    for (let i = 0; i < Tline[fromIndex].length; i++) {
      if (Tline[fromIndex][i] != 0) {
        ...
        // multiple transition for this current state
          ...
          content += `${this.conditionCode(
            this.data.inputCondition[fromIndex][i],
            flag
          )}
                                <span class="lineBlock">
                                    <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
